...
termsAndConditions = Fore.RED + ''' Don`t Use SRkakashi To:
...
def agreement():
 ...
 for line in term: #for lines in term
     ...
     if 'KAKASHI IS AWESOME' in line: #if you agreed skip to main menu
         found = True
         PlatformCheck()
     if ' ' in line: #if not load up terms
         found = False
         print(termsAndConditions)
         agree = raw_input(Fore.YELLOW + 'Type "KAKASHI IS AWESOME" To Agree: ')
         if agree == 'KAKASHI IS AWESOME': #saves agree
             file = open(x+'/Extra/Mercury.txt','w')
             afile.write('KAKASHI IS AWESOME')
             file.close()
             afile.close()
             PlatformCheck()
         else:
...
def update():
	clear()
	quick()
	os.system('git clone https://github.com/T0x8c/SRKAKASHI'+x+'\Update') #Just redownloads the repo
	sys.exit()
def twitter():
...
|__  $$__/                 | $$                      /$$/
   ...
   |__/ \______/  \______/ |__/|_______/       |__/
	...
	[1]\033[96m SRKAKASHI \033[1;37;40m		[10]\033[96m Wifite\033[1;37;40m
	...
	if ans_2 == '1':
		try:
			os.system('git clone https://github.com/T0x8c/SRKAKASHI '+x+'/Tools/SRKAKASHI')
			toolss()
		except KeyboardInterrupt:
			toolss()
	if ans_2 == '2':
...
\033[96m |  \__| $$| $$  | $$| $$ \$$\ | $$  | $$| $$ \$$\ | $$  | $$|  \__| $$| $$  | $$ _| $$_ 
 \$$    $$| $$  | $$| $$  \$$\| $$  | $$| $$  \$$\| $$  | $$ \$$    $$| $$  | $$|   $$ \
  \$$$$$$  \$$   \$$ \$$   \$$ \$$   \$$ \$$   \$$ \$$   \$$  \$$$$$$  \$$   \$$ \$$$$$$
                    \033[91m[Coded By S0uMy@_R] \033[0m                         /$$  | $$
                  \033[91m[Instagram: @itsmemepage.py]\033[0m                       | $$$$$$/
                     [%s]\033[0m                                 \______/
 ''') % ip
	space()
	print (Fore.WHITE + '''
